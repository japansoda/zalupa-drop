...
mapping = {
    "case_achroma.webp": "case_achroma",
    "case_ascent.webp": "case_ascent",
    "case_boreal.webp": "case_boreal",
    "case_harlequin.webp": "case_harlequin",
    "case_radiant.webp": "case_radiant",
}

print("Initializing rembg session with u2netp...")
...
print("All 5 collection cases processed successfully!")
